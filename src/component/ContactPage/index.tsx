  ...
  return (
    <section id="contact">
      <div className="w-full h-auto min-h-[100vh] bg-white px-5 flex flex-col justify-center items-center gap-6 font-inter py-10">
        ...
        <div className=" w-full lg:w-[90%] xl:w-[70%] 2xl:w-[60%] h-auto p-2 md:items-center flex flex-col  lg:flex-row justify-between">
          {/* EMAIL FORM */}
          ...
          {/* INFO */}
          <div className="w-full md:w-[80%] md:justify-center  lg:w-[30%] h-auto flex flex-col justify-start gap-10 pt-10 items-start">
            <div className="grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-1 gap-6 w-full">
              {information.map((info, index) => (
                ...
                >
                  <div className="bg-primary rounded-full lg:p-4 xl:p-5 p-3 ">
                    <img
                      src={info.img}
                      alt={`Topic ${index}`}
                      className="max-h-[25px] max-w-[25px] lg:h-[20px] lg:w-[20px] xl:h-[25px] xl:w-[25px] object-contain"
                    />
                  </div>
                  <p className="text-md sm:text-lg md:mr-5 text-gray-700">
                    {info.desc}
                  </p>
                </div>
              ))}
